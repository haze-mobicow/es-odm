...
function Model(connection, defaults, opt,schema) {
  ...
  var mapping = this.schema.getIndexMappingJSON();
  console.log(this.schema.getIndexMapping())
  // todo compare mappings.
  connection.indices.putMapping({index:this.index,type:this.type, body:mapping.properties })
}
